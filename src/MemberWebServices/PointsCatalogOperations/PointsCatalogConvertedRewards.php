...
class PointsCatalogConvertedRewards 
{
    private $callApiObj;
    private $body = [];
    ...
    public function __construct($memberAccessToken, $memberAccountNumber)
    {
        ...
        $this->URLPARAMS = "member-connect.excentus.com/fuelrewards/public/rest/v2/" . $this->programUdk . "/members/" . $memberAccountNumber . "/retailers/". $this->programUdk . "/catalog/rewards"; 
