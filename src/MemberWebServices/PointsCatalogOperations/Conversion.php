...
class Conversion 
{
    ...
    public function __construct($memberAccessToken, $memberAccountNumber, $offerUdk, $timestamp, $timezone)
    {
        $this->headers = [
        ...
        $this->URLPARAMS = "member-connect.excentus.com/fuelrewards/public/rest/v2/" . $this->programUdk . "/members/" . $memberAccountNumber . "/convert"; 
